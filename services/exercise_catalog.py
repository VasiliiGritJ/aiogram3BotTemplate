...
EXERCISE_DEFINITIONS = (
    ...
    _e("incline_push_up", "Отжимания от высокой опоры", "chest", "bodyweight", ("gym", "functional_gym", "street", "home"), "horizontal_push", "bodyweight_reps", "horizontal_chest_press", "Выберите устойчивую опору и держите корпус прямым.", secondary=("triceps", "core")),
    ...
    _e("inverted_row", "Горизонтальные подтягивания", "back", "pullup_dip_station", ("gym", "functional_gym", "street", "home"), "horizontal_pull", "bodyweight_reps", "horizontal_row", "Держите тело прямым и тяните грудь к перекладине.", secondary=("biceps", "core")),
    _e("pull_up", "Подтягивания прямым хватом", "back", "pullup_dip_station", ("gym", "functional_gym", "street", "home"), "vertical_pull", "bodyweight_reps", "vertical_pull", "Не раскачивайтесь и начинайте движение лопатками.", levels=INTERMEDIATE_PLUS, secondary=("biceps",)),
    _e("chin_up", "Подтягивания обратным хватом", "back", "pullup_dip_station", ("gym", "functional_gym", "street", "home"), "vertical_pull", "bodyweight_reps", "vertical_pull", "Поднимайтесь без рывка и контролируйте опускание.", levels=INTERMEDIATE_PLUS, secondary=("biceps",)),
    ...
    _e("dumbbell_goblet_squat", "Приседания с гантелью перед грудью", "quads", "dumbbell", ("gym", "functional_gym", "home"), "squat", "external_load_reps", "goblet_squat", "Держите гантель у груди и сохраняйте опору всей стопы.", secondary=("glutes", "core")),
    _e("dumbbell_split_squat", "Сплит-присед с гантелями", "quads", "dumbbell", ("gym", "functional_gym", "home"), "squat", "external_load_reps", "split_squat", "Опускайтесь вертикально в устойчивой стойке.", secondary=("glutes",)),
    ...
    _e("reverse_lunge", "Обратные выпады", "quads", "bodyweight", ("gym", "functional_gym", "street", "home"), "squat", "bodyweight_reps", "lunge", "Шагайте назад и сохраняйте устойчивость передней стопы.", secondary=("glutes",)),
    _e("step_up", "Зашагивания на устойчивую тумбу", "quads", "functional_equipment", ("gym", "functional_gym", "street", "home"), "squat", "external_load_reps", "step_up", "Используйте устойчивую опору и поднимайтесь за счёт рабочей ноги.", secondary=("glutes",)),
    ...
    _e("dumbbell_romanian_deadlift", "Румынская тяга с гантелями", "hamstrings", "dumbbell", ("gym", "functional_gym", "home"), "hinge", "external_load_reps", "romanian_deadlift", "Сохраняйте нейтральную спину и отводите таз назад.", secondary=("glutes", "back"), restrictions=("back",)),
    ...
    _e("kettlebell_deadlift", "Становая тяга с гирей", "hamstrings", "functional_equipment", ("gym", "functional_gym", "home"), "hinge", "external_load_reps", "floor_deadlift", "Поставьте гирю между стопами и поднимайтесь за счёт ног и таза.", secondary=("glutes", "back")),
    _e("slider_leg_curl", "Сгибание ног со скольжением лёжа", "hamstrings", "functional_equipment", ("functional_gym", "home"), "isolation", "bodyweight_reps", "leg_curl", "Удерживайте таз поднятым и двигайте пятки плавно.", secondary=("glutes", "core")),
    ...
    # Shoulders
    _e("lateral_raise", "Подъём рук в стороны с гантелями", "shoulders", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "lateral_raise", "Поднимайте руки без рывка до комфортной высоты."),
    _e("dumbbell_shoulder_press", "Жим гантелей сидя", "shoulders", "dumbbell", ("gym", "functional_gym", "home"), "vertical_push", "external_load_reps", "vertical_press", "Сохраняйте корпус устойчивым и не сводите гантели ударом.", secondary=("triceps",)),
    ...
    _e("dumbbell_rear_delt_fly", "Разведение гантелей в наклоне", "shoulders", "dumbbell", ("gym", "functional_gym", "home"), "horizontal_pull", "external_load_reps", "rear_delt_fly", "Удерживайте нейтральную спину и работайте без рывка.", secondary=("back",)),
    ...
    # Arms
    _e("dumbbell_curl", "Сгибание рук с гантелями стоя", "biceps", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "elbow_flexion", "Не уводите локти вперёд и не раскачивайтесь."),
    ...
    _e("hammer_curl", "Молотковые сгибания с гантелями", "biceps", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "elbow_flexion", "Удерживайте нейтральный хват и неподвижные локти."),
    ...
    _e("dumbbell_overhead_triceps_extension", "Разгибание рук с гантелью из-за головы", "triceps", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "elbow_extension", "Не разводите локти и удерживайте корпус устойчивым."),
    _e("dumbbell_skull_crusher", "Разгибание рук с гантелями лёжа", "triceps", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "elbow_extension", "Опускайте гантели плавно по сторонам головы."),
    ...
    _e("bench_dip", "Обратные отжимания от скамьи", "triceps", "bodyweight", ("gym", "functional_gym", "street", "home"), "vertical_push", "bodyweight_reps", "dip", "Используйте устойчивую опору и не опускайтесь глубже комфортного.", secondary=("chest", "shoulders"), restrictions=("shoulder",)),
    ...
    _e("dumbbell_calf_raise", "Подъём на носки с гантелями", "calves", "dumbbell", ("gym", "functional_gym", "home"), "isolation", "external_load_reps", "calf_raise", "Не торопитесь в нижней точке."),
    ...
    _e("ab_wheel_rollout", "Выкатывание ролика с колен", "core", "functional_equipment", ("gym", "functional_gym", "home"), "core", "bodyweight_reps", "anti_extension_core", "Двигайтесь только в амплитуде, где сохраняете нейтральную поясницу.", levels=INTERMEDIATE_PLUS, restrictions=("back",)),
    ...
    _e("kettlebell_swing", "Махи гирей", "glutes", "functional_equipment", ("gym", "functional_gym", "home"), "hinge", "timed_conditioning", "ballistic_hinge", "Разгоняйте гирю движением таза, а не подъёмом рук.", levels=INTERMEDIATE_PLUS, secondary=("hamstrings", "core")),
    _e("kettlebell_goblet_squat", "Приседания с гирей перед грудью", "quads", "functional_equipment", ("gym", "functional_gym", "home"), "squat", "external_load_reps", "goblet_squat", "Держите гирю близко к груди и сохраняйте устойчивые стопы.", secondary=("glutes", "core")),
